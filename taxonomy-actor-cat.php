...
<div class="ActorPage">
	<div class="container">
		<div class="right">
			<div class="header">
				<h1><i class="fa fa-bars"></i><span><?=$term->name?></span></h1>
				<div class="share">
					<ul>
						<span>شارك : </span>
			...
			<div class="OtherActors">
				<h2 class="TitleAreaTwo">
			        <i class="fa fa-th-large"></i>
			        <span>شاهد ممثلون اخرون</span>
			    </h2>
			    <div class="Holder">
			    	<?php 
			    		$args = array(
			    		...
			    		shuffle($actors)
			    	?>
			    	<?php foreach (array_slice($actors, 0,14) as $actor) { ?>
			    		<li>
		...
		<div class="left">
			<div class="MostViews">
				<h1><i class="fa fa-clock-o"></i><p>اعمال</p><span><?=$term->name?></span><em>المضافه حديثا</em></h1>
				<ul>
					<?php
						$taxQuery = new WP_Query(array(
							'post_type' => array('movie','serie'),
			...
			<div class="MostViews" style="margin-top: 15px">
				<h1><i class="fa fa-fire"></i><p>اعمال</p><span><?=$term->name?></span><em>الاكثر مشاهده</em></h1>
				<ul>
					<?php
						$taxQuery = new WP_Query(array(
							'post_type' => array('movie','serie'),
